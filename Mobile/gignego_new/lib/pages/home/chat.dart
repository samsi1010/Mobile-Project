...
if (widget.jobId == null) {
  ...
  return;
    ...
    final url = Uri.parse(
      'http://192.168.100.4:8080/messages?user1=$currentUserEmail&user2=${widget.chatWithEmail}&job_id=${widget.jobId}',
    );
  ...
  Future<void> _sendMessage() async {
    ...
    final url = Uri.parse('http://192.168.100.4:8080/messages');
    try {
